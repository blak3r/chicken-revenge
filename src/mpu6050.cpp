...
void mpu6050_initForInterrupts() {
    ...
    writeByte(MPU6050_ADDRESS, MOT_DUR, 60); //Originally 40 - Set motion detect duration to 1  ms; LSB is 1 ms @ 1 kHz rate  
...
void mpu6050_clearInterruptRegisters() {
  uint8_t readdata = readByte(MPU6050_ADDRESS, 0x3A);
